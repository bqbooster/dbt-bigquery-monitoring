{{ config(materialized=dbt_bigquery_monitoring_materialization(), tags=["dbt-bigquery-monitoring-information-schema-by-organization"], partition_by={'field': 'job_creation_time', 'data_type': 'timestamp', 'granularity': 'hour'}, partition_expiration_days=180) }}
