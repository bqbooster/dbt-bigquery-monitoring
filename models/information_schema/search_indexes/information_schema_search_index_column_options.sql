...
{%- if dataset_list | length == 0 -%}
  SELECT CAST(NULL AS STRING) AS index_catalog, CAST(NULL AS STRING) AS index_schema, CAST(NULL AS STRING) AS table_name, CAST(NULL AS STRING) AS index_name, CAST(NULL AS STRING) AS index_column_name, CAST(NULL AS STRING) AS option_name, CAST(NULL AS STRING) AS option_type, CAST(NULL AS STRING) AS option_value
  LIMIT 0
{%- else %}
