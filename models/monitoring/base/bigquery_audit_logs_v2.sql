...
SELECT
  jobChangeEvent.logName,
  jobChangeEvent.resource,
  jobChangeEvent.protopayload_auditlog,
  jobChangeEvent.textPayload,
  jobChangeEvent.timestamp,
  jobChangeEvent.receiveTimestamp,
  jobChangeEvent.severity,
  jobChangeEvent.insertId,
  jobChangeEvent.httpRequest,
  jobChangeEvent.operation,
  jobChangeEvent.trace,
  jobChangeEvent.spanId,
  jobChangeEvent.traceSampled,
  jobChangeEvent.sourceLocation,
  jobChangeEvent.split,
  jobChangeEvent.labels,
  jobChangeEvent.errorGroups,
  principalEmail,
  callerIp,
  callerSuppliedUserAgent,
  jobChangeEvent.timestamp AS eventTimestamp,
  serviceName,
  methodName,
  eventName,
  projectId,
